/*! For license information please see 6.ac47c0d1.iframe.bundle.js.LICENSE.txt */
  ...
  [6],
  {
    1165: function (module, __webpack_exports__, __webpack_require__) {
      ...
      var react__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(0),
        ...
        overlayscrollbars__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(1247),
        overlayscrollbars__WEBPACK_IMPORTED_MODULE_12___default = __webpack_require__.n(
          overlayscrollbars__WEBPACK_IMPORTED_MODULE_12__,
        );
      function _extends() {
        return (_extends =
          Object.assign ||
      ...
      var OverlayScrollbarsComponent = function OverlayScrollbarsComponent(_ref) {
        var _ref$options = _ref.options,
          ...
          osTargetRef = react__WEBPACK_IMPORTED_MODULE_11___default.a.useRef(),
          osInstance = react__WEBPACK_IMPORTED_MODULE_11___default.a.useRef();
        return (
          react__WEBPACK_IMPORTED_MODULE_11___default.a.useEffect(function () {
            return (
              (osInstance.current = overlayscrollbars__WEBPACK_IMPORTED_MODULE_12___default()(
                osTargetRef.current,
                options,
                extensions,
              )),
          ...
          react__WEBPACK_IMPORTED_MODULE_11___default.a.useEffect(
            function () {
              overlayscrollbars__WEBPACK_IMPORTED_MODULE_12___default.a.valid(osInstance.current) &&
          ...
          react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement(
            ...
            react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement('div', { className: 'os-scrollbar-corner' }),
          )
        );
      };
      function mergeHostClassNames(osInstance, className) {
        if (overlayscrollbars__WEBPACK_IMPORTED_MODULE_12___default.a.valid(osInstance)) {
          var host = osInstance.getElements().host,
            regex = new RegExp(
              '(^os-host([-_].+|)$)|'.concat(osInstance.options().className.replace(/\s/g, '$|'), '$'),
              'g',
            ),
              ...
              var _targets,
                      ...
                      if (!jsCache[LEXICON.hOP](name)) {
                        for (result = window[name]; i < jsPrefixes[LEXICON.l]; i++)
                          result =
                            result ||
                            window[
                              (isInterface ? jsPrefixes[i] : jsPrefixes[i].toLowerCase()) + firstLetterToUpper(name)
                            ];
                        jsCache[name] = result;
                      }
                ...
                COMPATIBILITY = (function () {
                  ...
                  return {
                    ...
                    page: function (event) {
                      var eventDoc =
                          ((event = event.originalEvent || event).target || event.srcElement || document)
                      ...
                      return 0 == t
                        ...
                        : (p || (p = 0.3 * d),
                          a < _easingsMath.a(c)
                            ? ((a = c), (s = p / 4))
                            : (s = (p / (2 * _easingsMath.p)) * _easingsMath.n(c / a)),
                          a * _easingsMath.w(2, -10 * t) * _easingsMath.s(((t * d - s) * (2 * _easingsMath.p)) / p) +
                            c +
                            b);
                    },
                ...
                FRAMEWORK = (function () {
                        ...
                        for (name in options)
                          (src = target[name]),
                            target !== (copy = options[name]) &&
                              (deep && copy && (isPlainObject(copy) || (copyIsArray = COMPATIBILITY.isA(copy)))
                                ? (copyIsArray
                                    ? ((copyIsArray = !1), (clone = src && COMPATIBILITY.isA(src) ? src : []))
                  ...
                  function each(obj, callback) {
                    var i = 0;
                    if (isArrayLike(obj)) for (; i < obj[LEXICON.l] && !1 !== callback.call(obj[i], i, obj[i]); i++);
                  ...
                  function isArrayLike(obj) {
                    ...
                    return (
                      !isFunction(t) &&
                      (t == TYPES_a || 0 === length || (_type(length) == TYPES_n && length > 0 && length - 1 in obj))
                    );
                  }
                          ...
                          (timeStart = COMPATIBILITY.now()),
                            (frame = function () {
                              ...
                              isFunction(progress) && progress({}, percent, MATH.max(0, duration - elapsed)),
                                  ...
                                  ? (startNextAnimationInQ(animObj), isFunction(complete) && complete())
                  ...
                  function FakejQuery(selector) {
                    ...
                    if (_type(selector) == TYPES_s)
                      for (
                        elements = [],
                          '<' === selector.charAt(0)
                            ? (((el = document.createElement('div')).innerHTML = selector), (elms = el.children))
                  ...
                  return (
                    (FakejQuery[LEXICON.p] = {
                      ...
                      unwrap: function () {
                        ...
                        for (
                          this.each(function () {
                            -1 === inArray((parent = this.parentNode), parents) && parents.push(parent);
                          }),
                            i = 0;
                          i < parents[LEXICON.l];
                          i++
                      ...
                      wrapAll: function (wrapperHTML) {
                        ...
                        for (i = 0; this[LEXICON.l] - i; deepest.firstChild === this[0] && i++)
                      ...
                      hasClass: function (className) {
                        for (
                          var elem, classList, i = 0, classNamePrepared = ' ' + className + ' ';
                          (elem = this[i++]);
                          ...
                          if (
                            1 === elem.nodeType &&
                            (' ' + stripAndCollapse(elem.className + '') + ' ').indexOf(classNamePrepared) > -1
                          )
                            return !0;
                        }
                        return !1;
                        ...
                        if (className)
                          for (classes = className.match(_rnothtmlwhite) || []; (elem = this[i++]); )
                            if (
                              ...
                              supportClassList === undefined && (supportClassList = elmClassList !== undefined),
                              supportClassList)
                            )
                        ...
                        return (
                          this.each(function () {
                            for (ch = this.children, i = 0; i < ch[LEXICON.l]; i++)
                              (el = ch[i]),
                                selector
                                  ? ((el.matches && el.matches(selector)) || matches(el, selector)) && children.push(el)
                                  : children.push(el);
                          }),
                          FakejQuery(children)
                        );
                      ...
                      contents: function () {
                        ...
                        return (
                          this.each(function () {
                            for (childs = this.childNodes, i = 0; i < childs[LEXICON.l]; i++) contents.push(childs[i]);
                          }),
                          FakejQuery(contents)
                        );
                      },
                ...
                PLUGIN = (function () {
                              ...
                              for (var prop in template)
                                if (template[LEXICON.hOP](prop) && data[LEXICON.hOP](prop)) {
                                  var restrictedStringValuesSplit,
                                    ...
                                    error = 'The option "' + propPrefix + prop + '" wasn\'t set, because',
                                    errorPossibleTypes = [],
                                  ...
                                  if (
                                    ...
                                    for (i = 0; i < templateTypes[LEXICON.l]; i++)
                                      if (
                                        ...
                                        (isRestrictedValue =
                                          (templateValueType = type(currType)) == TYPES_s &&
                                        ...
                                        for (
                                          errorPossibleTypes.push(TYPES_s),
                                            ...
                                            errorRestrictedStrings =
                                              errorRestrictedStrings.concat(restrictedStringValuesSplit),
                                            v = 0;
                                    ...
                                    isValid
                                      ? ((isDiff = dataValue !== dataDiffValue) && (validatedOptions[prop] = dataValue),
                                        (isRestrictedValue
                                          ? inArray(dataDiffValue, restrictedStringValuesPossibilitiesSplit) < 0
                                          : isDiff) &&
                                        ...
                                        console.warn(
                                          error +
                                            ...
                                            (errorRestrictedStrings[length] > 0
                                              ? '\r\nValid strings are: [ ' +
                                                errorRestrictedStrings.join(', ').split(':').join(', ') +
                                                ' ].'
                                              : ''),
                                        ),
                                      delete data[prop];
                  ...
                  function initOverlayScrollbarsStatics() {
                    _pluginsGlobals || (_pluginsGlobals = new OverlayScrollbarsGlobals(_pluginsOptions._defaults)),
                      _pluginsAutoUpdateLoop ||
                  ...
                  function OverlayScrollbarsGlobals(defaultOptions) {
                    ...
                    var nativeScrollbarSize = calcNativeScrollbarSize(scrollbarDummyElement0),
                      nativeScrollbarIsOverlaid = { x: 0 === nativeScrollbarSize.x, y: 0 === nativeScrollbarSize.y },
                      msie = (function () {
                        var result,
                    ...
                    FRAMEWORK.extend(_base, {
                      ...
                      nativeScrollbarStyling: (function () {
                        ...
                        try {
                          result =
                            ('none' === scrollbarDummyElement.css('scrollbar-width') && (msie > 9 || !msie)) ||
                            'none' ===
                              window
                      ...
                      rtlScrollBehavior: (function () {
                        scrollbarDummyElement
                          .css({ 'overflow-y': 'hidden', 'overflow-x': 'scroll', direction: 'rtl' })
                          .scrollLeft(0);
                      ...
                      (this.remove = function (instance) {
                        ...
                        index > -1 &&
                          ...
                          0 === _loopingInstances[_strLength] &&
                            ...
                            _loopID !== undefined && (COMPATIBILITY.cAF()(_loopID), (_loopID = -1))));
                      });
                  }
                  function OverlayScrollbarsInstance(
                    ...
                    if (isHTMLElement(pluginTargetElement)) {
                      ...
                      var _nativeScrollbarIsOverlaid,
                        ...
                        _classNameHostScrollbarHorizontalHidden =
                          _classNameHostElement + '-scrollbar-horizontal-hidden',
                      ...
                      return (
                            ...
                            return (
                              type(force) == TYPES_s
                                ...
                                : ((force = _sleeping || force),
                                  (_sleeping = !1),
                                  (_base.update('sync') && !force) || update({ _force: force })),
                        ...
                        (_base.destroy = function () {
                          if (!_destroyed) {
                            ...
                            for (var i = 0; i < _updateOnLoadElms[LEXICON.l]; i++)
                              FRAMEWORK(_updateOnLoadElms[i]).off('load', updateOnLoadCallback);
                        ...
                        (_base.scroll = function (coordinates, duration, easing, complete) {
                          if (0 === arguments.length || coordinates === undefined) {
                            ...
                            return (
                              ...
                              {
                                position: { x: (scrollX *= normalizeNegate ? -1 : 1), y: infoY._currentScroll },
                                ...
                                handleLengthRatio: { x: infoX._handleLengthRatio, y: infoY._handleLengthRatio },
                          ...
                          var i,
                            ...
                            possibleElementIsJQuery =
                              !!(possibleElement instanceof FRAMEWORK || JQUERY) && possibleElement instanceof JQUERY,
                            possibleElementIsHTMLElement = !possibleElementIsJQuery && isHTMLElement(possibleElement),
                          ...
                          function getRawScroll(isX, coordinates) {
                            ...
                            if (
                              ((coordinates =
                                type(coordinates) == TYPES_s || type(coordinates) == TYPES_n
                              ...
                              (isString
                                ? (rawScroll[strLength] > 2 &&
                                  ...
                                  (rawScroll = (rawScroll = operator ? rawScroll.substr(2) : rawScroll)
                                    ...
                                    .replace(
                                      /%/g,
                                      ' * ' + (maxScroll * (isRTLisX && _rtlScrollBehavior.n ? -1 : 1)) / 100,
                                    )
                          ...
                          function getPerAxisValue(value, valueInternalType, defaultValue, allowedValues) {
                            ...
                            if (valueType == valueInternalType) value = [value, value];
                              ...
                              value =
                                valueType == TYPES_o
                                  ? [value.x || defaultValue, value.y || defaultValue]
                                  : resultDefault;
                          ...
                          function generateMargin(marginTopRightBottomLeftArray) {
                            ...
                            for (
                              i = 0;
                              i < marginTopRightBottomLeftArray[strLength] && i !== valueDirections[strLength];
                              i++
                            )
                              (currValue = marginTopRightBottomLeftArray[i]),
                                (currValueType = type(currValue)) == TYPES_b
                                  ? result.push(
                                      currValue
                                        ? parseToZeroOrNumber(finalElement.css('margin-' + valueDirections[i]))
                                        : 0,
                                    )
                            ...
                            if (
                              ...
                              (margin =
                                marginType == TYPES_n || marginType == TYPES_b
                                  ...
                                  : marginDefault),
                                (settingsAxis = checkSettingsStringValue(axis, elementObjSettingsAxisValues)
                                  ? axis
                                  : 'xy'),
                                ...
                                (_isRTL &&
                                  (_rtlScrollBehavior.n ||
                                    ...
                                    (elementScrollCoordinates.x = MATH.round(
                                      viewportOffset.left - elementOffset.left + viewportScroll.l,
                                    )),
                                ...
                                var measuringElm = finalElement[0],
                                  ...
                                  finalizeBlock = function (isX) {
                                    var vars = getScrollbarVars(isX),
                                      ...
                                      lt = vars._left_top,
                                      xy = vars._x_y,
                                      blockIsEnd = settingsBlock[xy] == (isX && _isRTL ? strBegin : strEnd),
                        ...
                        (_base.getState = function (stateProperty) {
                          function prepare(obj) {
                            ...
                            return (
                              changePropertyName('w', 'width'),
                              changePropertyName('h', 'height'),
                              delete extended.c,
                              extended
                            );
                          }
                          ...
                          if (registeredExtensionObj) {
                            ...
                            if (
                              ...
                              type(instanceContract) == TYPES_f &&
                                ...
                                (contractFulfilled =
                                  type(contractResult) == TYPES_b ? contractResult : contractFulfilled)),
                              contractFulfilled)
                            )
                              return (
                            ...
                            return (
                              ...
                              (_domExists = _isTextarea
                                ? _targetElement.hasClass(_classNameTextareaElement) &&
                                  _targetElement.parent().hasClass('os-content')
                                : _targetElement.hasClass(_classNameHostElement) &&
                                  _targetElement.children('.os-padding')[LEXICON.l]),
                              _nativeScrollbarIsOverlaid.x &&
                              _nativeScrollbarIsOverlaid.y &&
                              !_currentPreparedOptions.nativeScrollbarsOverlaid.initialize
                                ? (dispatchCallback('onInitializationWithdrawn'),
                                  _domExists &&
                                    (setupStructureDOM(!0), setupScrollbarsDOM(!0), setupScrollbarCornerDOM(!0)),
                                  (_destroyed = !0),
                                  (_sleeping = !0),
                                  _base)
                                : (_isBody &&
                                    ...
                                    (initBodyScroll.t = MATH.max(
                                      _targetElement.scrollTop(),
                                      _htmlElement.scrollTop(),
                                      _windowElement.scrollTop(),
                                    )),
                                  ...
                                  (function setupScrollbarCornerEvents() {
                                    ...
                                    function onMouseTouchDownContinue(event) {
                                      ...
                                      return (
                                        !_sleeping && !_destroyed && (1 === COMPATIBILITY.mBtn(event) || isTouchEvent)
                                      );
                                    }
                        ...
                        if (onElementResizedCallback) {
                          if (_supportResizeObserver)
                            ...
                            var isDirty,
                              ...
                              reset = function () {
                                expandElement.scrollLeft(3333333).scrollTop(3333333),
                                  shrinkElement.scrollLeft(3333333).scrollTop(3333333);
                              },
                              onResized = function () {
                                (rAFId = 0),
                                  isDirty && ((widthCache = currWidth), (heightCache = currHeight), callback());
                              },
                              onScroll = function (event) {
                                return (
                                  ...
                                  event && isDirty && !rAFId
                                    ? (COMPATIBILITY.cAF()(rAFId), (rAFId = COMPATIBILITY.rAF()(onResized)))
                                    : event || onResized(),
                                  reset(),
                              ...
                              doUpdate &&
                                ...
                                (action = function () {
                                  _destroyed ||
                                    ...
                                    sizeAuto ? update() : _base.update('auto'));
                                }),
                                clearTimeout(contentTimeout),
                                now - contentLastUpdate > 11 || !sizeAuto
                                  ? action()
                                  : (contentTimeout = setTimeout(action, 11)))),
                            doUpdate
                          );
                        }),
                    ...
                    function update(updateHints) {
                      ...
                      if (
                        ...
                        var checkCacheAutoForce = function () {
                          ...
                          paddingAbsoluteChanged = checkCacheAutoForce(paddingAbsolute, _paddingAbsoluteCache),
                          ...
                          sizeAutoCapableChanged = checkCacheAutoForce(sizeAutoCapable, _sizeAutoCapableCache),
                          ...
                          textareaDynWidthChanged = checkCacheAutoForce(_textareaDynWidthCache, textareaDynWidth),
                          textareaDynHeight = currentPreparedOptionsTextarea.dynHeight,
                          textareaDynHeightChanged = checkCacheAutoForce(_textareaDynHeightCache, textareaDynHeight);
                        if (
                          ...
                          classNameChanged &&
                            ...
                            addClass(
                              _hostElement,
                              className !== undefined && null !== className && className.length > 0
                                ? className
                                : _classNameThemeNone,
                            )),
                          autoUpdateChanged &&
                          ...
                          if (sizeAutoCapable)
                            if (
                              (_contentGlueElement
                                ...
                                : ((_contentGlueElement = FRAMEWORK(generateDiv('os-content-glue'))),
                        ...
                        force &&
                          ...
                          (displayIsHidden =
                            displayIsHidden === undefined ? _hostElement.is(':hidden') : displayIsHidden);
                        ...
                        var isRTLLeft = (_isRTL = 'rtl' === cssDirection) ? 'left' : 'right',
                          ...
                          widthAutoObserverDetection =
                            ...
                            0 ===
                              MATH.round(sizeAutoObserverElementBCRect.right - sizeAutoObserverElementBCRect.left) &&
                        ...
                        var widthAuto =
                          ...
                          heightAuto =
                            ...
                            0 === MATH.round(sizeAutoObserverElementBCRect.bottom - sizeAutoObserverElementBCRect.top),
                          ...
                          getViewportSize = function () {
                            return {
                              w:
                                ...
                                MATH.max(0, _contentElementNative[LEXICON.cW] - _contentElementNative[LEXICON.sW]),
                              h:
                                _paddingElementNative[LEXICON.oH] +
                                MATH.max(0, _contentElementNative[LEXICON.cH] - _contentElementNative[LEXICON.sH]),
                            };
                          },
                        ...
                        if (
                          ...
                          cssDirectionChanged &&
                            _sizeAutoObserverAdded &&
                            _sizeAutoObserverElement.css('float', isRTLRight),
                          padding.c ||
                            cssDirectionChanged ||
                          ...
                          setTopRightBottomLeft(contentGlueElementCSS, 'margin-', [
                            -padding.t,
                            -padding.r,
                            -padding.b,
                            -padding.l,
                        ...
                        var textareaSize = !!_isTextarea && textareaUpdate(),
                          textareaSizeChanged = _isTextarea && checkCacheAutoForce(textareaSize, _textareaSizeCache),
                          textareaDynOrigSize =
                        ...
                        if (
                          ...
                          heightAuto &&
                          (heightAutoChanged || paddingAbsoluteChanged || boxSizingChanged || padding.c || border.c)
                          ...
                          (widthAutoChanged ||
                            ...
                            : (widthAutoChanged || paddingAbsoluteChanged) &&
                              ((contentElementCSS.width = '100%'),
                              (contentElementCSS.float = ''),
                              (contentGlueElementCSS['max-width'] = '')),
                          widthAuto
                            ? ((contentGlueElementCSS.width = 'auto'),
                              (contentElementCSS.width =
                                VENDORS._cssPropertyValue('width', 'max-content intrinsic') || 'auto'),
                              (contentElementCSS.float = isRTLRight))
                            : (contentGlueElementCSS.width = ''),
                          (contentGlueElementCSS.height = heightAuto
                          ...
                          if (!_nativeScrollbarStyling) {
                            var viewportElementResetCSS = {},
                              resetXTmp =
                                _hasOverflowCache.y && _hideOverflowCache.ys && !ignoreOverlayScrollbarHiding
                                  ? _nativeScrollbarIsOverlaid.y
                            ...
                            var textareaCoverCSS = {},
                              setContentGlueElementCSSfunction = function (horizontal) {
                                var scrollbarVars = getScrollbarVars(horizontal),
                                  ...
                                  viewportSize =
                                    _viewportSize[wh] - borderSize - marginSize - (_isBorderBox ? 0 : paddingSize);
                          ...
                          (contentScrollSize.c = contentSizeChanged =
                            ...
                            (_viewportSize = getViewportSize()),
                            (hostSizeChanged = checkCacheAutoForce((hostSize = getHostSize()), _hostSizeCache)),
                              ...
                              (overflowBehaviorIsVS[xy] = 'v-s' === overflowBehavior[xy]),
                                ...
                                (hideOverflow[xy] =
                                  overflowBehaviorIsVS[xy] || overflowBehaviorIsVH[xy]
                                    ...
                                    : hasOverflow[xy]),
                                (hideOverflow[xy + 's'] =
                                  !!hideOverflow[xy] && (overflowBehaviorIsS[xy] || overflowBehaviorIsVS[xy])),
                          ...
                          if (
                            ...
                            (hasOverflow.x || hasOverflow.y) &&
                              ...
                              (hasOverflow.c ||
                                ...
                                heightAuto ||
                                ignoreOverlayScrollbarHidingChanged) &&
                                ((contentElementCSS['margin-' + isRTLRight] = contentElementCSS[
                                  'border-' + isRTLRight
                                ] =
                                  ''),
                              ...
                              ignoreOverlayScrollbarHiding &&
                                ((arrangeContent.w = arrangeContent.h = ''), (arrangeChanged = !0)),
                              arrangeChanged &&
                                !_nativeScrollbarStyling &&
                            ...
                            (hostSizeChanged ||
                              ...
                              hideOverflowForceTextarea
                                ...
                                : (!clipAlways ||
                                  ...
                                  (_isTextarea &&
                                    (paddingElementCSS['overflow-x'] = paddingElementCSS['overflow-y'] = ''),
                                  (viewportElementCSS['overflow-x'] = viewportElementCSS['overflow-y'] = 'visible')),
                              _paddingElement.css(paddingElementCSS),
                              _viewportElement.css(viewportElementCSS),
                              (viewportElementCSS = {}),
                              (hasOverflow.c || boxSizingChanged || widthAutoChanged || heightAutoChanged) &&
                                (!_nativeScrollbarIsOverlaid.x || !_nativeScrollbarIsOverlaid.y)))
                          ) {
                          ...
                          if ((_contentElement.css(contentElementCSS), _isTextarea && contentSizeChanged)) {
                            var textareaInfo = (function getTextareaInfo() {
                              ...
                              if (textareaCursorPosition !== undefined) {
                                var rowCols,
                                  ...
                                  cursorCol =
                                    textareaCurrentCursorRowSplit[textareaCurrentCursorRowSplit[LEXICON.l] - 1][
                                      LEXICON.l
                                    ];
                            ...
                            if (textareaInfo) {
                              var textareaRowsChanged =
                                  _textareaInfoCache === undefined || textareaInfo._rows !== _textareaInfoCache._rows,
                                ...
                                cursorIsLastPosition =
                                  textareaInfo._cursorPosition >= textareaInfo._cursorMax && _textareaHasFocus,
                                textareaScrollAmount = {
                                  x:
                                    textareaAutoWrapping || cursorCol !== lastCol || cursorRow !== widestRow
                                      ? -1
                          ...
                          addRemoveClass(_hostElement, _classNameHostOverflow, hideOverflow.x || hideOverflow.y),
                            ...
                            cssDirectionChanged && !_isBody && addRemoveClass(_hostElement, _classNameHostRTL, _isRTL),
                            ...
                            scrollbarsDragScrollingChanged && refreshScrollbarsInteractive(!1, scrollbarsDragScrolling),
                            dispatchCallback(
                              'onDirectionChanged',
                        ...
                        eachUpdateOnLoad(function (i, updateOnLoadSelector) {
                          _contentElement.find(updateOnLoadSelector).each(function (i, el) {
                            COMPATIBILITY.inA(el, _updateOnLoadElms) < 0 &&
                              ...
                              FRAMEWORK(el).off('load', updateOnLoadCallback).on('load', updateOnLoadCallback));
                          });
                        });
                    }
                    ...
                    function setupStructureDOM(destroy) {
                      ...
                      (_hostElement =
                        ...
                        (_viewportElement =
                          _viewportElement || selectOrGenerateDivByClass('os-viewport' + textareaClass)),
                        (_paddingElement = _paddingElement || selectOrGenerateDivByClass('os-padding' + textareaClass)),
                        (_sizeObserverElement =
                          _sizeObserverElement || selectOrGenerateDivByClass('os-resize-observer-host')),
                        (_textareaCoverElement =
                          _textareaCoverElement ||
                          (_isTextarea ? selectOrGenerateDivByClass(_classNameTextareaCoverElement) : undefined)),
                        ...
                        destroy
                          ? (_domExists && _initialized
                              ? (_sizeObserverElement.children().remove(),
                                each(
                                  [_paddingElement, _viewportElement, _contentElement, _textareaCoverElement],
                                  function (i, elm) {
                          ...
                          : (_isTextarea &&
                              (_currentPreparedOptions.sizeAutoCapable ||
                                ((hostElementCSS.width = _targetElement.css('width')),
                                (hostElementCSS.height = _targetElement.css('height'))),
                    ...
                    function setupStructureEvents() {
                      var textareaUpdateIntervalID,
                        ...
                        textareaKeyDownRestrictedKeyCodes = [
                          112, 113, 114, 115, 116, 117, 118, 119, 120, 121, 123, 33, 34, 37, 38, 39, 40, 16, 17, 18, 19,
                          20, 144,
                        ],
                    ...
                    function setupScrollbarEvents(isHorizontal) {
                        ...
                        if (onMouseTouchDownContinue(event)) {
                          var trackLength = scrollbarVarsInfo._trackLength,
                            ...
                            scrollDelta =
                              ...
                              (((getPointerPosition(event) - mouseDownOffset) * mouseDownInvertedScale) /
                      ...
                      function documentMouseTouchUp(event) {
                        if (
                          ...
                          COMPATIBILITY.rAF()(function () {
                            setupResponsiveEventListener(_documentElement, 'click', stopClickEventPropagation, !0, {
                              _capture: !0,
                            });
                          }),
                          ...
                          trackTimeout !== undefined &&
                            (_base.scrollStop(), clearTimeout(trackTimeout), (trackTimeout = undefined)),
                          event)
                        ) {
                      ...
                      function onHandleMouseTouchDownAction(event) {
                        (mouseDownScroll = _viewportElement[scroll]()),
                          ...
                          COMPATIBILITY.rAF()(function () {
                            setupResponsiveEventListener(_documentElement, 'click', stopClickEventPropagation, !1, {
                              _capture: !0,
                            });
                          }),
                                ...
                                var decreaseScroll,
                                  handleToViewportRatio =
                                    ...
                                    Math.round(
                                      MATH.min(
                                        1,
                                        _viewportSize[scrollbarVars._w_h] / _contentScrollSizeCache[scrollbarVars._w_h],
                                    ...
                                    if (!_destroyed) {
                                      var mouseOffset = (mouseDownOffset - trackOffset) * mouseDownInvertedScale,
                                        ...
                                        rtlIsNormal =
                                          _isRTL &&
                                          isHorizontal &&
                                          ((!_rtlScrollBehavior.i && !_rtlScrollBehavior.n) || _normalizeRTLCache),
                        ...
                        _supportTransition &&
                          addDestroyEventListener(scrollbarVars._scrollbar, _strTransitionEndEvent, function (event) {
                            event.target === scrollbarVars._scrollbar[0] &&
                              (refreshScrollbarHandleLength(isHorizontal), refreshScrollbarHandleOffset(isHorizontal));
                          });
                    }
                    function refreshScrollbarAppearance(isHorizontal, shallBeVisible, canScroll) {
                      ...
                      addRemoveClass(
                        _hostElement,
                        isHorizontal ? _classNameHostScrollbarHorizontalHidden : _classNameHostScrollbarVerticalHidden,
                        !shallBeVisible,
                      ),
                        ...
                        var anyActive,
                          hide = function () {
                            _scrollbarsHandleHovered ||
                              _destroyed ||
                              (!(anyActive =
                                _scrollbarHorizontalHandleElement.hasClass('active') ||
                                _scrollbarVerticalHandleElement.hasClass('active')) &&
                    ...
                    function refreshScrollbarHandleOffset(isHorizontal, scrollOrTransition) {
                      var transformOffset,
                        ...
                        currentScroll =
                          scrollOrTransition === undefined || transition ? nativeScroll : scrollOrTransition,
                        handleLength = scrollbarVarsInfo._handleLength,
                                        ...
                                        var strResult,
                                          ...
                                          splitCssStyleByComma = function (str) {
                                            ...
                                            for (; str.match(regExpMain); )
                                              strResult.push(RegExp.$1), (str = str.replace(regExpMain, ''));
                                            return strResult;
                                          };
                    ...
                    function refreshScrollbarsInteractive(isTrack, value) {
                      var action = value ? 'removeClass' : 'addClass',
                        element2 = isTrack ? _scrollbarVerticalTrackElement : _scrollbarVerticalHandleElement,
                        className = isTrack ? _classNameScrollbarTrackOff : _classNameScrollbarHandleOff;
                      (isTrack ? _scrollbarHorizontalTrackElement : _scrollbarHorizontalHandleElement)[action](
                        className,
                      ),
                    ...
                    function setupScrollbarCornerDOM(destroy) {
                      (_scrollbarCornerElement =
                        _scrollbarCornerElement || selectOrGenerateDivByClass('os-scrollbar-corner', !0)),
                        destroy
                          ? _domExists && _initialized
                      ...
                      var i,
                        ...
                        appendClasses = function (classes, condition) {
                          if (((appendix = ''), condition && typeof classes == TYPES_s))
                            for (split = classes.split(' '), i = 0; i < split[LEXICON.l]; i++)
                              appendix += '|' + split[i] + '$';
                          return appendix;
                        };
                      return new RegExp(
                    ...
                    function getHostElementInvertedScale() {
                      ...
                      return {
                        ...
                        y:
                          (_supportTransform && 1 / (MATH.round(rect.height) / _paddingElementNative[LEXICON.oH])) || 1,
                      };
                    }
                  ...
                  return (
                    ...
                    (_plugin.defaultOptions = function (newDefaultOptions) {
                      ...
                      if (newDefaultOptions === undefined) return FRAMEWORK.extend(!0, {}, currDefaultOptions);
                      _pluginsGlobals.defaultOptions = FRAMEWORK.extend(
                        !0,
                        {},
                        currDefaultOptions,
                        _pluginsOptions._validate(newDefaultOptions, _pluginsOptions._template, !0, currDefaultOptions)
                          ._default,
                      );
                    }),
                        ...
                        if (COMPATIBILITY.type(extension) == TYPES_f)
                          ...
                          for (; i < _pluginsExtensions[LEXICON.l]; i++)
                            if (_pluginsExtensions[i].name === extensionName) {
                              if (!(argLen > 1)) return FRAMEWORK.extend(!0, {}, _pluginsExtensions[i]);
...
//# sourceMappingURL=6.ac47c0d1.iframe.bundle.js.map
