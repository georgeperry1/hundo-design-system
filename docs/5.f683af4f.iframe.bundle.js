(window.webpackJsonp = window.webpackJsonp || []).push([
  [5],
  {
    1167: function (module, __webpack_exports__, __webpack_require__) {
      ...
      var index_module_c = 'undefined' != typeof window ? react.useLayoutEffect : react.useEffect;
      function index_module_i(e) {
        var r = Object(react.useRef)(e);
        return (
      ...
      var index_module_s,
        index_module_f = function (e, r, t) {
          return void 0 === r && (r = 0), void 0 === t && (t = 1), e > t ? t : e < r ? r : e;
        },
        index_module_v = function (e) {
          return 'touches' in e;
        },
        index_module_d = function (e, r) {
          var t = e.getBoundingClientRect(),
            o = index_module_v(r) ? r.touches[0] : r;
          return {
            left: index_module_f((o.pageX - (t.left + window.pageXOffset)) / t.width),
            top: index_module_f((o.pageY - (t.top + window.pageYOffset)) / t.height),
          };
        },
        index_module_h = react_default.a.memo(function (r) {
          var t = r.onMove,
            s = r.onKey,
            f = index_module_u(r, ['onMove', 'onKey']),
            h = Object(react.useRef)(null),
            m = Object(react.useRef)(!1),
            g = Object(react.useState)(!1),
            p = g[0],
            b = g[1],
            _ = index_module_i(t),
            C = index_module_i(s),
            E = Object(react.useCallback)(
              function (e) {
                e.preventDefault(),
                  (index_module_v(e) ? e.touches.length > 0 : e.buttons > 0) && h.current
                    ? _(index_module_d(h.current, e))
                    : b(!1);
              },
              [_],
            ),
            x = Object(react.useCallback)(
              function (e) {
                var r = e.nativeEvent;
                r.preventDefault(),
                  (function (e) {
                    return !((m.current && !index_module_v(e)) || (m.current || (m.current = index_module_v(e)), 0));
                  })(r) && (_(index_module_d(h.current, r)), b(!0));
              },
              [_],
            ),
            H = Object(react.useCallback)(
              function (e) {
                ...
                r < 37 ||
                  r > 40 ||
                  (e.preventDefault(),
                  C({ left: 39 === r ? 0.05 : 37 === r ? -0.05 : 0, top: 40 === r ? 0.05 : 38 === r ? -0.05 : 0 }));
              },
              [C],
            ),
            ...
            w = Object(react.useCallback)(
              function (e) {
                var r = e ? window.addEventListener : window.removeEventListener;
                r(m.current ? 'touchmove' : 'mousemove', E), r(m.current ? 'touchend' : 'mouseup', N);
              },
              [E, N],
            );
          return (
        ...
        index_module_ = function (e) {
          var r = /hsla?\((\d+\.?\d*),\s*(\d+\.?\d*)%?,\s*(\d+\.?\d*)%?,?\s*(\d+\.?\d*)?\)/.exec(e);
          return r
            ? index_module_E({
                h: Number(r[1]),
                s: Number(r[2]),
        ...
        index_module_x = function (e) {
          ...
          return {
            ...
            s: index_module_p(n > 0 && n < 200 ? ((r * t) / 100 / (n <= 100 ? n : 200 - n)) * 100 : 0),
            l: index_module_p(n / 2),
            a: index_module_p(o, 2),
          };
        },
        index_module_H = function (e) {
          var r = index_module_x(e);
        ...
        index_module_w = function (e) {
          ...
          var a = Math.floor(r),
            ...
            i = a % 6;
          return {
            r: index_module_p(255 * [o, u, l, l, c, o][i]),
            g: index_module_p(255 * [c, o, o, u, l, l][i]),
            b: index_module_p(255 * [l, l, c, o, o, u][i]),
        ...
        q = function (e) {
          ...
          return r
            ? I({ r: Number(r[1]), g: Number(r[2]), b: Number(r[3]), a: void 0 === r[4] ? 1 : Number(r[4]) })
            : { h: 0, s: 0, v: 0, a: 1 };
        },
        O = function (e) {
          var r = e.toString(16);
        ...
        z = react_default.a.memo(function (r) {
          var t = r.hue,
            o = r.onChange,
            n = index_module_m(['react-colorful__hue', r.className]);
          return react_default.a.createElement(
            'div',
            { className: n },
            react_default.a.createElement(
              ...
              react_default.a.createElement(index_module_g, {
                ...
                left: t / 360,
                color: index_module_H({ h: t, s: 100, v: 100, a: 1 }),
              }),
            ),
          );
        }),
        B = react_default.a.memo(function (r) {
          var t = r.hsva,
            o = r.onChange,
            n = { backgroundColor: index_module_H({ h: t.h, s: 100, v: 100, a: 1 }) };
          return react_default.a.createElement(
            'div',
            ...
            react_default.a.createElement(
              index_module_h,
              {
                ...
                'aria-label': 'Color',
                'aria-valuetext': 'Saturation ' + index_module_p(t.s) + '%, Brightness ' + index_module_p(t.v) + '%',
              },
              react_default.a.createElement(index_module_g, {
                className: 'react-colorful__saturation-pointer',
                top: 1 - t.v / 100,
                left: t.s / 100,
                color: index_module_H(t),
              }),
            ),
          );
        }),
      ...
      function D(e, r, l) {
        var u = index_module_i(l),
          ...
          s = c[0],
          f = c[1],
          v = Object(react.useRef)({ color: r, hsva: s });
      ...
      var L,
        ...
        T = function () {
          index_module_c(function () {
            if ('undefined' != typeof document && !L) {
              ...
              var e = index_module_s || __webpack_require__.nc;
        ...
        X = function (r) {
          var t = r.className,
            ...
            c = r.onChange,
            i = index_module_u(r, ['className', 'colorModel', 'color', 'onChange']);
          T();
          var s = D(o, a, c),
            f = s[0],
            v = s[1],
          ...
          return react_default.a.createElement(
            'div',
            index_module_l({}, i, { className: d }),
            react_default.a.createElement(B, { hsva: f, onChange: v }),
            react_default.a.createElement(z, { hue: f.h, onChange: v, className: 'react-colorful__last-control' }),
          );
        },
        Y = {
          defaultColor: '000',
          toHsva: function (e) {
            return I(index_module_b(e));
          },
          fromHsva: function (e) {
            return (t = (r = index_module_w(e)).g), (o = r.b), '#' + O(r.r) + O(t) + O(o);
            var r, t, o;
          },
          equal: function (e, r) {
            return e.toLowerCase() === r.toLowerCase() || K(index_module_b(e), index_module_b(r));
          },
        },
        P = function (r) {
          var t = r.className,
            ...
            a = {
              backgroundImage:
                ...
                index_module_N(Object.assign({}, o, { a: 0 })) +
                ', ' +
                index_module_N(Object.assign({}, o, { a: 1 })) +
                ')',
            },
          ...
          return react_default.a.createElement(
            'div',
            { className: l },
            react_default.a.createElement('div', { className: 'react-colorful__alpha-gradient', style: a }),
            react_default.a.createElement(
              index_module_h,
              {
                onMove: function (e) {
                ...
                'aria-label': 'Alpha',
                'aria-valuetext': index_module_p(100 * o.a) + '%',
              },
              react_default.a.createElement(index_module_g, {
                className: 'react-colorful__alpha-pointer',
                left: o.a,
                color: index_module_N(o),
              }),
            ),
          );
        },
        R = function (r) {
          ...
          return react_default.a.createElement(
            ...
            index_module_l({}, i, { className: d }),
            react_default.a.createElement(B, { hsva: f, onChange: v }),
            react_default.a.createElement(z, { hue: f.h, onChange: v }),
            react_default.a.createElement(P, { hsva: f, onChange: v, className: 'react-colorful__last-control' }),
          );
        },
        Q = { defaultColor: 'hsla(0, 0%, 0%, 1)', toHsva: index_module_, fromHsva: index_module_N, equal: A },
        fe = {
          defaultColor: 'rgba(0, 0, 0, 1)',
          toHsva: q,
          fromHsva: function (e) {
            var r = index_module_w(e);
            return 'rgba(' + r.r + ', ' + r.g + ', ' + r.b + ', ' + r.a + ')';
          },
          equal: A,
        },
        color_convert = __webpack_require__(1238),
        color_convert_default = __webpack_require__.n(color_convert),
        throttle = __webpack_require__(1241),
        throttle_default = __webpack_require__.n(throttle),
        esm = __webpack_require__(2),
        TooltipNote = __webpack_require__(627),
        lazy_WithTooltip = __webpack_require__(195),
        esm_form = __webpack_require__(69),
      ...
      var Wrapper = esm.styled.div({ position: 'relative', maxWidth: 250 }),
        PickerTooltip = Object(esm.styled)(lazy_WithTooltip.a)({ position: 'absolute', zIndex: 1, top: 4, left: 4 }),
        ...
        Color_Swatch = function Swatch(_ref3) {
          ...
          return react_default.a.createElement(
            ...
            _extends({}, props, {
              active: active,
              onClick: onClick,
              style: Object.assign({}, style, { backgroundImage: backgroundImage }),
            }),
          );
        };
      ...
      var COLOR_SPACES = Object.values(ColorSpace),
        ...
        ColorPicker =
          (_defineProperty((_ColorPicker = {}), ColorSpace.HEX, function (r) {
            return react_default.a.createElement(X, index_module_l({}, r, { colorModel: Y }));
          }),
          _defineProperty(_ColorPicker, ColorSpace.RGB, function (r) {
            return react_default.a.createElement(R, index_module_l({}, r, { colorModel: fe }));
          }),
          _defineProperty(_ColorPicker, ColorSpace.HSL, function (r) {
            return react_default.a.createElement(R, index_module_l({}, r, { colorModel: Q }));
          }),
          _ColorPicker),
        fallbackColor =
          ...
          if (value) {
            ...
            if (RGB_REGEXP.test(value)) {
              var _ref8,
                ...
                b = _stringToArgs2[2],
                a = _stringToArgs2[3],
                _ref7 = _slicedToArray(color_convert_default.a.rgb.hsl([r, g, b]) || [0, 0, 0], 3),
                h = _ref7[0],
                s = _ref7[1],
                l = _ref7[2];
              return (
                ...
                _defineProperty(
                  _ref8,
                  ColorSpace.HSL,
                  'hsla('.concat(h, ', ').concat(s, '%, ').concat(l, '%, ').concat(a, ')'),
                ),
                _defineProperty(
                  _ref8,
                  ColorSpace.HEX,
                  '#'.concat(color_convert_default.a.rgb.hex([r, g, b]).toLowerCase()),
                ),
                _ref8
              );
            }
            if (HSL_REGEXP.test(value)) {
              var _ref11,
                ...
                _l = _stringToArgs4[2],
                _a = _stringToArgs4[3],
                _ref10 = _slicedToArray(color_convert_default.a.hsl.rgb([_h, _s2, _l]) || [0, 0, 0], 3),
                _r = _ref10[0],
                _g = _ref10[1],
                _b = _ref10[2];
              return (
                _defineProperty(
                  ...
                  ColorSpace.RGB,
                  'rgba('.concat(_r, ', ').concat(_g, ', ').concat(_b, ', ').concat(_a, ')'),
                ),
                _defineProperty(_ref11, ColorSpace.HSL, value),
                _defineProperty(
                  _ref11,
                  ColorSpace.HEX,
                  '#'.concat(color_convert_default.a.hsl.hex([_h, _s2, _l]).toLowerCase()),
                ),
                _ref11
              );
            }
            var plain = value.replace('#', ''),
              rgb = color_convert_default.a.keyword.rgb(plain) || color_convert_default.a.hex.rgb(plain),
        ...
        Color_useColorInput = function useColorInput(initialValue, onChange) {
          var _useState2 = _slicedToArray(Object(react.useState)(initialValue || ''), 2),
            value = _useState2[0],
            ...
            _useState6 = _slicedToArray(
              Object(react.useState)((null == color ? void 0 : color.colorSpace) || ColorSpace.HEX),
              2,
            ),
            colorSpace = _useState6[0],
            setColorSpace = _useState6[1],
            realValue = Object(react.useMemo)(
              function () {
        ...
        Color_ColorControl = function ColorControl(_ref13) {
          var initialValue = _ref13.value,
            ...
            _useColorInput = Color_useColorInput(initialValue, throttle_default()(onChange, 200)),
            ...
            _usePresets = (function usePresets(presetColors, currentColor, colorSpace) {
              var _useState8 = _slicedToArray(
                  Object(react.useState)(null != currentColor && currentColor.valid ? [currentColor] : []),
                  2,
                ),
                selectedColors = _useState8[0],
                setSelectedColors = _useState8[1],
                presets = Object(react.useMemo)(
                  function () {
                    return (presetColors || [])
                      .map(function (preset) {
                        return 'string' == typeof preset
                          ...
                          : preset.title
                          ? Object.assign({}, Color_parseValue(preset.color), { keyword: preset.title })
          ...
          return react_default.a.createElement(
            ...
            react_default.a.createElement(
                      ...
                      presets.map(function (preset) {
                        return react_default.a.createElement(
                          lazy_WithTooltip.a,
                          {
                            key: preset.value,
                            hasChrome: !1,
                            tooltip: react_default.a.createElement(Note, { note: preset.keyword || preset.value }),
                          },
              ...
              react_default.a.createElement(Color_Swatch, { value: realValue, style: { margin: 4 } }),
            ),
    ...
    1182: function (module, exports, __webpack_require__) {
      const cssKeywords = __webpack_require__(1239),
        reverseKeywords = {};
    ...
    1238: function (module, exports, __webpack_require__) {
      const conversions = __webpack_require__(1182),
        route = __webpack_require__(1240),
        convert = {};
    ...
    1241: function (module, exports, __webpack_require__) {
      var debounce = __webpack_require__(1242),
    ...
    1242: function (module, exports, __webpack_require__) {
      var isObject = __webpack_require__(124),
        now = __webpack_require__(1243),
        toNumber = __webpack_require__(1244),
        nativeMax = Math.max,
        nativeMin = Math.min;
    ...
    1244: function (module, exports, __webpack_require__) {
      var baseTrim = __webpack_require__(1245),
        isObject = __webpack_require__(124),
    ...
    1245: function (module, exports, __webpack_require__) {
      var trimmedEndIndex = __webpack_require__(1246),
        reTrimStart = /^\s+/;
    ...
    627: function (module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__(26), __webpack_require__(16), __webpack_require__(143);
      ...
      var Note = __webpack_require__(2).styled.div(function (_ref) {
        ...
        TooltipNote = function TooltipNote(_ref2) {
          ...
          return react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(Note, props, note);
        };
