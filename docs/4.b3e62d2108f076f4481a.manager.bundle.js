/*! For license information please see 4.b3e62d2108f076f4481a.manager.bundle.js.LICENSE.txt */
(window.webpackJsonp = window.webpackJsonp || []).push([
  [4],
  {
    ...
    1002: function (module, exports, __webpack_require__) {
      'use strict';
      var normalize = __webpack_require__(1003),
        Schema = __webpack_require__(1006),
        DefinedInfo = __webpack_require__(1007);
    ...
    1007: function (module, exports, __webpack_require__) {
      'use strict';
      var Info = __webpack_require__(1008),
        types = __webpack_require__(1004);
    ...
    1009: function (module, exports, __webpack_require__) {
      'use strict';
      var caseSensitiveTransform = __webpack_require__(1034);
      ...
      function markup(Prism) {
        (Prism.languages.markup = {
          ...
          Prism.hooks.add('wrap', function (env) {
            'entity' === env.type && (env.attributes.title = env.content.value.replace(/&amp;/, '&'));
          }),
                ...
                if (
                  ('string' != typeof token &&
                    ('tag' === token.type && token.content[0] && 'tag' === token.content[0].type
                      ...
                      : openedTags.length > 0 && 'punctuation' === token.type && '{' === token.content
                  ...
                  i < tokens.length - 1 &&
                    ...
                    i > 0 &&
                      ('string' == typeof tokens[i - 1] || 'plain-text' === tokens[i - 1].type) &&
                      ((plainText = stringifyToken(tokens[i - 1]) + plainText), tokens.splice(i - 1, 1), i--),
    ...
    1019: function (module, exports, __webpack_require__) {
      'use strict';
      var _interopRequireDefault = __webpack_require__(1001);
      Object.defineProperty(exports, '__esModule', { value: !0 }), (exports.default = void 0);
      var _highlight = _interopRequireDefault(__webpack_require__(1020)),
        _core = _interopRequireDefault(__webpack_require__(1025)),
    ...
    1020: function (module, exports, __webpack_require__) {
      ...
      Object.defineProperty(exports, '__esModule', { value: !0 }),
        (exports.default = function _default(defaultAstGenerator, defaultStyle) {
          return function SyntaxHighlighter(_ref7) {
            var language = _ref7.language,
              ...
              code = void 0 === _ref7$code ? (Array.isArray(children) ? children[0] : children) : _ref7$code,
      ...
      var _objectWithoutProperties2 = _interopRequireDefault(__webpack_require__(1021)),
        _objectSpread2 = _interopRequireDefault(__webpack_require__(1005)),
        _react = _interopRequireDefault(__webpack_require__(0)),
        _createElement = _interopRequireDefault(__webpack_require__(1023)),
        _checkForListedLanguage = _interopRequireDefault(__webpack_require__(1024)),
        newLineRegex = /\n/g;
      function AllLineNumbers(_ref2) {
        var codeString = _ref2.codeString,
          ...
          containerStyle =
            void 0 === _ref2$containerStyle ? { float: 'left', paddingRight: '10px' } : _ref2$containerStyle,
      ...
      function assembleLineNumberStyles(lineNumberStyle, lineNumber, largestLineNumber) {
        var num,
          ...
          defaultLineNumberStyle = {
            ...
            minWidth: ((num = largestLineNumber), (len = num.toString().length), ''.concat(len, 'em')),
            paddingRight: '1em',
            textAlign: 'right',
            userSelect: 'none',
          },
          customLineNumberStyle = 'function' == typeof lineNumberStyle ? lineNumberStyle(lineNumber) : lineNumberStyle;
        return (0, _objectSpread2.default)({}, defaultLineNumberStyle, customLineNumberStyle);
      }
    ...
    1021: function (module, exports, __webpack_require__) {
      var objectWithoutPropertiesLoose = __webpack_require__(1022);
    ...
    1023: function (module, exports, __webpack_require__) {
      ...
      var _extends2 = _interopRequireDefault(__webpack_require__(464)),
        _objectSpread2 = _interopRequireDefault(__webpack_require__(1005)),
        _react = _interopRequireDefault(__webpack_require__(0));
      ...
      function createElement(_ref) {
        ...
        if (TagName) {
          var childrenCreator = createChildren(stylesheet, useInlineStyles),
            ...
            className = nonStylesheetClassNames && nonStylesheetClassNames.length ? nonStylesheetClassNames : void 0,
            props = useInlineStyles
              ...
              : (0, _objectSpread2.default)({}, properties, { className: createClassNameString(properties.className) }),
            children = childrenCreator(node.children);
          return _react.default.createElement(TagName, (0, _extends2.default)({ key: key }, props), children);
        }
      }
    },
    ...
    1025: function (module, exports, __webpack_require__) {
      ...
      (function (global) {
        ...
        var h = __webpack_require__(1026),
          decode = __webpack_require__(1042),
          Prism = __webpack_require__(1049),
          markup = __webpack_require__(1011),
          css = __webpack_require__(1012),
          clike = __webpack_require__(1050),
          js = __webpack_require__(1051);
        restore();
        ...
        (module.exports = refract),
          (refract.highlight = function highlight(value, name) {
            var grammar,
              sup = Prism.highlight;
            if ('string' != typeof value) throw new Error('Expected `string` for `value`, got `' + value + '`');
            if ('Object' === refract.util.type(name)) (grammar = name), (name = null);
            else {
              if ('string' != typeof name) throw new Error('Expected `string` for `name`, got `' + name + '`');
          ...
          (refract.alias = function alias(name, alias) {
            ...
            for (key in map)
              for (
                list = map[key], length = (list = 'string' == typeof list ? [list] : list).length, index = -1;
                ++index < length;
            ...
            if ('Array' === refract.util.type(value))
              return (function stringifyAll(values, language) {
                var value,
                  ...
                  index = -1;
                for (; ++index < length; ) '' !== (value = values[index]) && null != value && result.push(value);
      ...
      }.call(this, __webpack_require__(80)));
    },
    ...
    1027: function (module, exports, __webpack_require__) {
      'use strict';
      var schema = __webpack_require__(1028),
        html = __webpack_require__(1037)(schema, 'div');
      (html.displayName = 'html'), (module.exports = html);
    },
    1028: function (module, exports, __webpack_require__) {
      'use strict';
      var merge = __webpack_require__(1029),
        xlink = __webpack_require__(1031),
        xml = __webpack_require__(1032),
        xmlns = __webpack_require__(1033),
        aria = __webpack_require__(1035),
        html = __webpack_require__(1036);
      module.exports = merge([xml, xlink, xmlns, aria, html]);
    },
    1029: function (module, exports, __webpack_require__) {
      'use strict';
      var xtend = __webpack_require__(1030),
        Schema = __webpack_require__(1006);
    ...
    1031: function (module, exports, __webpack_require__) {
      'use strict';
      var create = __webpack_require__(1002);
    ...
    1033: function (module, exports, __webpack_require__) {
      'use strict';
      var create = __webpack_require__(1002),
        caseInsensitiveTransform = __webpack_require__(1009);
      module.exports = create({
        space: 'xmlns',
    ...
    1035: function (module, exports, __webpack_require__) {
      'use strict';
      var types = __webpack_require__(1004),
        create = __webpack_require__(1002),
    ...
    1037: function (module, exports, __webpack_require__) {
      'use strict';
      var find = __webpack_require__(1038),
        normalize = __webpack_require__(1003),
        parseSelector = __webpack_require__(1039),
        spaces = __webpack_require__(1040).parse,
        commas = __webpack_require__(1041).parse;
      module.exports = function factory(schema, defaultTagName, caseSensitive) {
        var adjust = caseSensitive
          ? (function createAdjustMap(values) {
              var value,
                ...
                index = -1,
                result = {};
              for (; ++index < length; ) (value = values[index]), (result[value.toLowerCase()] = value);
              return result;
            })(caseSensitive)
          : null;
        return function h(selector, properties) {
          ...
          (node.tagName = adjust && own.call(adjust, name) ? adjust[name] : name),
            properties && isChildren(properties, node) && (children.unshift(properties), (properties = null));
          if (properties) for (property in properties) addProperty(node.properties, property, properties[property]);
        ...
        function addProperty(properties, key, value) {
          ...
          null != value &&
            ...
            'className' === property && properties.className && (result = properties.className.concat(result)),
            (properties[property] = (function parsePrimitives(info, name, value) {
              var index, length, result;
              if ('object' != typeof value || !('length' in value)) return parsePrimitive(info, name, value);
        ...
        return (
          info.number || info.positiveNumber
            ...
            : (info.boolean || info.overloadedBoolean) &&
              ('string' != typeof result || ('' !== result && normalize(value) !== normalize(name)) || (result = !0)),
          result
        );
      }
    },
    ...
    1042: function (module, exports, __webpack_require__) {
      'use strict';
      var legacy = __webpack_require__(1043),
        invalid = __webpack_require__(1044),
        decimal = __webpack_require__(1010),
        hexadecimal = __webpack_require__(1045),
        alphanumerical = __webpack_require__(1046),
        decodeEntity = __webpack_require__(1048);
      module.exports = function parseEntities(value, options) {
        var option,
          key,
          settings = {};
        options || (options = {});
        for (key in defaults) (option = options[key]), (settings[key] = null == option ? defaults[key] : option);
        (settings.position.indent || settings.position.start) &&
          ((settings.indent = settings.position.indent || []), (settings.position = settings.position.start));
                    ...
                    ? type === name
                      ? (terminated && !entity
                          ...
                          : (entityCharacters !== characters &&
                              ((end = begin + entityCharacters.length), (diff = 1 + end - begin), (terminated = !1)),
                            terminated ||
                      ...
                      : (terminated || warning(2, diff),
                        ...
                        ((code = reference) >= 55296 && code <= 57343) || code > 1114111
      ...
      var own = {}.hasOwnProperty,
        ...
        tests = {};
      (tests[name] = alphanumerical), (tests.decimal = decimal), (tests[hexa] = hexadecimal);
      var messages = {};
    ...
    1046: function (module, exports, __webpack_require__) {
      'use strict';
      var alphabetical = __webpack_require__(1047),
        decimal = __webpack_require__(1010);
    ...
    1049: function (module, exports, __webpack_require__) {
      (function (global) {
        var Prism = (function (_self) {
                        ...
                        for (var j = 0; j < patterns.length; ++j) {
                          ...
                          for (
                            ...
                            if (!(str instanceof Token)) {
                              ...
                              before &&
                                ((removeFrom = addAfter(tokenList, removeFrom, before)), (pos += before.length)),
          ...
          if (
            ...
            (Token.stringify = function stringify(o, language) {
              ...
              var env = {
                ...
                aliases = o.alias;
              aliases &&
                (Array.isArray(aliases) ? Array.prototype.push.apply(env.classes, aliases) : env.classes.push(aliases)),
          ...
          if (
            (script && ((_.filename = script.src), script.hasAttribute('data-manual') && (_.manual = !0)), !_.manual)
          ) {
    ...
    1052: function (module, exports, __webpack_require__) {
      ...
      var _interopRequireDefault = __webpack_require__(1001);
      Object.defineProperty(exports, '__esModule', { value: !0 }), (exports.default = void 0);
      var _default = _interopRequireDefault(__webpack_require__(1053)).default;
      exports.default = _default;
    },
    ...
    1054: function (module, exports, __webpack_require__) {
      ...
      var _interopRequireDefault = __webpack_require__(1001);
      Object.defineProperty(exports, '__esModule', { value: !0 }), (exports.default = void 0);
      var _default = _interopRequireDefault(__webpack_require__(1013)).default;
      exports.default = _default;
    },
    1055: function (module, exports, __webpack_require__) {
      ...
      var _interopRequireDefault = __webpack_require__(1001);
      Object.defineProperty(exports, '__esModule', { value: !0 }), (exports.default = void 0);
      var _default = _interopRequireDefault(__webpack_require__(1056)).default;
      exports.default = _default;
    },
    ...
    1057: function (module, exports, __webpack_require__) {
      ...
      var _interopRequireDefault = __webpack_require__(1001);
      Object.defineProperty(exports, '__esModule', { value: !0 }), (exports.default = void 0);
      var _default = _interopRequireDefault(__webpack_require__(1058)).default;
      exports.default = _default;
    },
    ...
    1059: function (module, exports, __webpack_require__) {
      ...
      var _interopRequireDefault = __webpack_require__(1001);
      Object.defineProperty(exports, '__esModule', { value: !0 }), (exports.default = void 0);
      var _default = _interopRequireDefault(__webpack_require__(1060)).default;
      exports.default = _default;
    },
              ...
              table: {
                ...
                inside: {
                  'table-data-rows': {
                    ...
                    lookbehind: !0,
                    inside: {
                      'table-data': { pattern: RegExp(tableCell), inside: Prism.languages.markdown },
                      punctuation: /\|/,
                    },
                  },
                  'table-line': {
                      ...
                      if ('code' === token.type) {
                        ...
                        if (
                          ...
                          var lang = codeLang.content.replace(/\b#/g, 'sharp').replace(/\b\+\+/g, 'pp'),
                            alias = 'language-' + (lang = (/[a-z][\w-]*/i.exec(lang) || [''])[0].toLowerCase());
                          codeBlock.alias
                ...
                if (grammar) {
                  ...
                  (env.attributes.id = id),
                    Prism.plugins.autoloader.loadLanguages(codeLang, function () {
                      ...
                      ele && (ele.innerHTML = Prism.highlight(ele.textContent, Prism.languages[codeLang], codeLang));
                    });
                }
              }
            }),
    ...
    1061: function (module, exports, __webpack_require__) {
      ...
      var _interopRequireDefault = __webpack_require__(1001);
      Object.defineProperty(exports, '__esModule', { value: !0 }), (exports.default = void 0);
      var _default = _interopRequireDefault(__webpack_require__(1062)).default;
      exports.default = _default;
    },
        ...
        !(function (Prism) {
              ...
              variable: [
                ...
                { pattern: /\$\((?:\([^)]+\)|[^()])+\)|`[^`]+`/, greedy: !0, inside: { variable: /^\$\(|^`|\)$|`$/ } },
                {
                  ...
                  inside: {
                    operator: /:[-=?+]?|[!\/]|##?|%%?|\^\^?|,,?/,
                    punctuation: /[\[\]]/,
                    environment: { pattern: RegExp('(\\{)' + envVars), lookbehind: !0, alias: 'constant' },
                  },
                },
                /\$(?:\w+|[#?*!@$])/,
              ],
          ...
          (Prism.languages.bash = {
            ...
            'assign-left': {
              pattern: /(^|[\s;|&]|[<>]\()\w+(?=\+?=)/,
              inside: {
                environment: { pattern: RegExp('(^|[\\s;|&]|[<>]\\()' + envVars), lookbehind: !0, alias: 'constant' },
              },
              alias: 'variable',
              lookbehind: !0,
            },
    ...
    1063: function (module, exports, __webpack_require__) {
      ...
      var _interopRequireDefault = __webpack_require__(1001);
      Object.defineProperty(exports, '__esModule', { value: !0 }), (exports.default = void 0);
      var _default = _interopRequireDefault(__webpack_require__(1012)).default;
      exports.default = _default;
    },
    1064: function (module, exports, __webpack_require__) {
      ...
      var _interopRequireDefault = __webpack_require__(1001);
      Object.defineProperty(exports, '__esModule', { value: !0 }), (exports.default = void 0);
      var _default = _interopRequireDefault(__webpack_require__(1011)).default;
      exports.default = _default;
    },
    1065: function (module, exports, __webpack_require__) {
      ...
      var _interopRequireDefault = __webpack_require__(1001);
      Object.defineProperty(exports, '__esModule', { value: !0 }), (exports.default = void 0);
      var _default = _interopRequireDefault(__webpack_require__(1066)).default;
      exports.default = _default;
    },
    1066: function (module, exports, __webpack_require__) {
      'use strict';
      var refractorJsx = __webpack_require__(1013),
        refractorTypescript = __webpack_require__(1014);
      function tsx(Prism) {
    ...
    1067: function (module, exports, __webpack_require__) {
      ...
      var _interopRequireDefault = __webpack_require__(1001);
      Object.defineProperty(exports, '__esModule', { value: !0 }), (exports.default = void 0);
      var _default = _interopRequireDefault(__webpack_require__(1014)).default;
      exports.default = _default;
    },
    1068: function (module, exports, __webpack_require__) {
      ...
      var _interopRequireDefault = __webpack_require__(1001);
      Object.defineProperty(exports, '__esModule', { value: !0 }), (exports.default = void 0);
      var _default = _interopRequireDefault(__webpack_require__(1069)).default;
      exports.default = _default;
    },
    ...
    995: function (module, __webpack_exports__, __webpack_require__) {
      ...
      prism_light_default.a.registerLanguage('jsextra', js_extras_default.a),
        ...
        prism_light_default.a.registerLanguage('typescript', typescript_default.a),
      ...
      syntaxhighlighter_copyToClipboard =
        null !== global_window.navigator && void 0 !== global_window.navigator && global_window.navigator.clipboard
                  ...
                  return regeneratorRuntime.wrap(function _callee$(_context) {
                    for (;;)
                      switch ((_context.prev = _context.next)) {
                        case 0:
                          (tmp = global_window.document.createElement('TEXTAREA')),
      ...
      var Wrapper = dist_esm.styled.div(
        ...
        syntaxhighlighter_SyntaxHighlighter = function SyntaxHighlighter(_ref10) {
          var children = _ref10.children,
            ...
            showLineNumbers = void 0 !== _ref10$showLineNumber && _ref10$showLineNumber,
